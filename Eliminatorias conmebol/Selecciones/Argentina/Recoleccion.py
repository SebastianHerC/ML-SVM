...
with open('Selecciones/Argentina/argentina.csv', mode='r', newline='', encoding='utf-8') as file:
    # Utiliza el delimitador de coma para leer el archivo
    reader = csv.reader(file, delimiter=',')
    
    # Aquí puedes realizar las operaciones de lectura en el archivo CSV
...
with open('nuevo_archivo.csv', mode='w', newline='', encoding='utf-8') as new_file:
