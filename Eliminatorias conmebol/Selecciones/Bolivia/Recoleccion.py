...
with open('Eliminatorias conmebol\Selecciones\Bolivia\overall_bol.csv', mode='r', newline='', encoding='utf-8') as file:
...
with open('overall_bol.csv', mode='w', newline='', encoding='utf-8') as new_file:
