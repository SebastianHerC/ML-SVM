...
with open('Eliminatorias conmebol\Selecciones\Brasil\overall_bra.csv', mode='r', newline='', encoding='utf-8') as file:
...
with open('overall_bra.csv', mode='w', newline='', encoding='utf-8') as new_file:
