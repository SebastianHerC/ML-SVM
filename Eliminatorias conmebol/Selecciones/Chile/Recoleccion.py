...
with open('Eliminatorias conmebol\Selecciones\Chile\overall_chile.csv', mode='r', newline='', encoding='utf-8') as file:
...
with open('overall_Cl.csv', mode='w', newline='', encoding='utf-8') as new_file:
